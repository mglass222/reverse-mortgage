export default {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        {
          en: 'MCA = lesser of appraised value and the FHA HECM limit (one national figure, $1,249,125 for 2026 — note it is a single nationwide cap, not the county-by-county schedule you use on forward FHA). For HECM for Purchase, the MCA is the lesser of appraised value or sales price, still subject to that national limit. Value above the cap is simply unmonetizable through the HECM; that is where a proprietary "jumbo reverse" enters the conversation. The MCA also sets the up-front MIP base and the 98% assignment threshold, so it is the anchor figure on the file.',
          ko: 'MCA = 감정가와 FHA HECM 한도 중 낮은 금액(전국 단일 수치, 2026년 $1,249,125 — 정방향 FHA에서 쓰는 카운티별 표가 아니라 전국 단일 한도임에 유의). 주택 구입용 HECM(HECM for Purchase)의 경우 MCA는 감정가 또는 매매가 중 낮은 금액이며, 여전히 전국 한도가 적용됩니다. 한도를 초과하는 가치는 HECM으로는 현금화할 수 없으며, 바로 이 지점에서 독자(프로프라이어터리) "점보 리버스"가 논의에 들어옵니다. MCA는 선납 MIP 기준과 98% 양도 임계치도 정하므로 파일의 기준 수치입니다.',
        },
      ],
    },
    {
