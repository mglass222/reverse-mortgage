  ...
  return (
    <figure className="diagram">
      <svg viewBox="0 0 320 200" role="img" aria-label={pick(L.aria)}>
        ...
        <path d="M40,150 C130,144 215,130 300,98" fill="none" stroke="#475569" strokeWidth="2" />
        {/* Loan balance: pronounced compounding — slow early, accelerating */}
        <path d="M40,166 C155,162 235,128 300,40" fill="none" stroke="#0ea372" strokeWidth="3" />
        <text x="210" y="55" fontSize="10" fill="#0ea372">{pick(L.balance)}</text>
        <text x="210" y="150" fontSize="10" fill="#475569">{pick(L.home)}</text>
        <text x="150" y="190" fontSize="10" fill="#69727e">{pick(L.time)}</text>
      </svg>
    </figure>
  )
}
